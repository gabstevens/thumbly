          ...
          <div className="w-full max-w-[1200px] flex flex-col min-h-screen px-4 sm:px-6">
            <header className="flex h-20 items-center justify-between py-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link
                  href="/app"
                  className="hidden sm:inline-flex items-center justify-center rounded-xl bg-foreground text-background px-5 py-2 text-sm font-bold hover:opacity-90 transition-all"
                >
                  Get Started
                </Link>
              </div>
            ...
            <footer className="py-12 border-t border-border">
              <div className="flex flex-col md:flex-row justify-between items-start gap-12">
                <div className="max-w-xs">
                  <div className="flex items-center gap-2 font-bold text-lg mb-4 text-foreground">Thumbly</div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-12">
                  ...
                  <div className="flex flex-col gap-3">
                    <h4 className="font-bold text-sm text-foreground">Social</h4>
                    <a
                      href="https://github.com/gabstevens/thumbly"
                      className="text-sm text-muted-foreground hover:text-primary transition-colors"
                    >
